...
object AuthDelegate {
    ...
    private const val AUTH_QUICK_URL = "https://api.iflyos.cn/thirdparty/general/quick_auth"
    ...
    private const val KEY_THIRDPARTY_ID = "thirdparty_id"
     ...
     * @param thirdpartyId 第三方账号系统用户唯一标识
            ...
            while (System.currentTimeMillis() / 1000 - current < expiresIn) {
                try {
                    ...
                    if (mode == AuthMode.DEFAULT) {
                        ...
                        val body = JSONObject()
                        body[KEY_GRANT_TYPE] = GRANT_TYPE_DEVICE_CODE
                        body[KEY_CLIENT_ID] = clientId
                        body[KEY_THIRDPARTY_ID] = thirdpartyId
                        body[KEY_DEVICE_CODE] = deviceCodeResponse.deviceCode
                        body[KEY_USER_CODE] = deviceCodeResponse.userCode
