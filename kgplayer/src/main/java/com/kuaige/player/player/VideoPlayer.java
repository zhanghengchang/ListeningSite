...
//        ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "fflags", "nobuffer");
        ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "analyzedmaxduration", 100);//分析码流时长:默认1024*1000

        ijkMediaPlayer.setOption(OPT_CATEGORY_FORMAT, "dns_cache_clear", 1);

        ijkMediaPlayer.setOption(OPT_CATEGORY_PLAYER, "framedrop", 30);
//        ijk rtmp
        ijkMediaPlayer.setOption(OPT_CATEGORY_FORMAT, "protocol_whitelist", "crypto,file,http,https,tcp,tls,udp,rtmp,rtsp");
    ...
    private void setEnableMediaCodec(IjkMediaPlayer ijkMediaPlayer, boolean isEnable) {
        ...
        ijkMediaPlayer.setOption(OPT_CATEGORY_PLAYER, "mediacodec", value);//开启硬解码
        ijkMediaPlayer.setOption(OPT_CATEGORY_PLAYER, "mediacodec-auto-rotate", value);
        ijkMediaPlayer.setOption(OPT_CATEGORY_PLAYER, "mediacodec-handle-resolution-change", value);
    }
    ...
    public void changeVideoSize() {
        ...
        mSurfaceView.setLayoutParams(new FrameLayout.LayoutParams(videoWidth, videoHeight,Gravity.CENTER));
    }
