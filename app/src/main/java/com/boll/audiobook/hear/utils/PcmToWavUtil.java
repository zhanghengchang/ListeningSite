...
public class PcmToWavUtil {
     ...
     */
    public void pcmToWav(int position, boolean deleteOrg) {
        String inFilename = Const.RECORDPATH + "record.pcm";//源文件路径
        String outFilename = Const.RECORDPATH + "record" + position + ".wav";//目标文件路径
        FileInputStream in;
    ...
    public void pcmToWav(int position) {
        pcmToWav(position, false);
    }
